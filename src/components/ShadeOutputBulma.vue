<template>
  <div class="w-full rounded shadow-lg mb-4 relative bg-gray-800">
...
export default {
  ...
  methods: {
    getSassVar(value) {
      return this.sassVars[value]
    },
    getSpaces(value) {
      let numberOfSpaces = 13 - this.getSassVar(value).length
      let str = ''
      for (var i = numberOfSpaces - 1; i >= 0; i--) {
        str += ' '
      }
      return str
    }
